...
urlpatterns = patterns('',
    ...
    url(r'^top//page/(?P<page>\d+)/(?P<records>\d+)', views.top, name='top'),
    url(r'^top/$', views.top, name='top'),
    url(r'^bottom//page/(?P<page>\d+)/(?P<records>\d+)', views.bottom, name='bottom'),
...
urlpatterns += patterns('',
    url(r'^page/(?P<page>\d+)/(?P<records>\d+)', views.index, name='index'),
