...
urlpatterns = patterns('',
    ...
    url(r'^register/((?:[a-zA-Z0-9])+-(?:[a-zA-Z0-9])+-(?:.)+)/$', views.register, name='register'),
    ...
    url(r'^member/(.+)/msg_to/$', views.msg_to_user, name='msg_to_user'),
    ...
    url(r'^incoming/sms/', views.incoming_message, name='incoming_message'),
    url(r'^incoming/receipt/', views.incoming_receipt, name='incoming_receipt'),
...
urlpatterns += patterns('',
    ...
    url(r'^t/(?P<tag>.+)//p/(?P<page>\d+)/(?P<records>\d+)', views.index, name='tag'),
    url(r'^t/(?P<tag>.+)/p/(?P<page>\d+)/(?P<records>\d+)', views.index, name='tag'),
    url(r'^t/(?P<tag>.+)/', views.index, name='tag'),
